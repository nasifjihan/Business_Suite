  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <PageHeader
        ...
        description="Define roles and assign granular permission codes."
        action={
      ...
      <GlobalModal
        ...
        title={
          modal.kind === "create" ? "Create new role" : "Edit role permissions"
        }
        description={
          isSystemEdit ? (
            <span className="text-violet-600 dark:text-violet-400 inline-flex items-center gap-1 text-xs">
              <ShieldAlert className="w-3 h-3" />
              System role — name is locked, only permissions can be adjusted
            </span>
          ) : undefined
        }
        size="lg"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <GlobalInput
              ...
              className={cn(isSystemEdit && "opacity-60")}
              {...form.register("name")}
            />
            <GlobalInput
              label="Display name"
            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Grant individual codes, or check entire modules at once.
                </p>
              </div>
      ...
      <ConfirmDialog
        ...
        description={
          modal.kind === "delete"
            ? `Deleting role ${modal.role.displayName} (${modal.role.userCount} users) will orphan those users without a role until reassigned. This action cannot be undone.`
            : ""
        }
        confirmText={
        ...
        confirmButtonClassName={cn(!canDelete && "opacity-60")}
